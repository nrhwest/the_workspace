...
public abstract class AbstractLinkedList<E> {
	...
	/*
	 * Helper method: Throws an IndexOutOfBoundsException if 0 <= index <= max
	 * is not true.
	 */
	...
	/*
	 * Returns the element of this list at the given index. Throws
	 * IndexOutOfBoundsException if index is out of range.
	 */
	public abstract E get(int index);

	/*
	 * Returns the first index where the given element occurs in this list, or
	 * -1 if the element is not in this list.
	 */
	public abstract int indexOf(E element);

	/*
	 * Returns the last index where the given element occurs in this list, or -1
	 * if the element is not in this list.
	 */
	public abstract int lastIndexOf(E element);

	/*
	 * Helper method: returns the node at the given index. -1 returns dummy
	 * header, and size() returns the dummy tail. Consider the effiency of this
	 * method. How can you write it minimize the number of comparisons?
	 */
	...
	protected class Node<E> {
		...
		/*
		 * Constructs a new node to store the given element and the given next
		 * node.
		 */
